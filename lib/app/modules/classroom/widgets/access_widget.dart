...
class AccessWidget extends GetView<ClassroomController> {
        ...
        children: [
          ...
          Obx(() {
            if (controller.loading.value) {
              ...
              return Column(
                children: List.generate(
                  controller.classroomInfos.value!.access.length > 3 ? 3 : controller.classroomInfos.value!.access.length,
                  (index) => Container(
                    decoration: BoxDecoration(
                        border:
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: AutoSizeText(
                            controller.classroomInfos.value!.access[index].user.name,
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              convertDateTimeToString(controller.classroomInfos.value!.access[index].openTime),
                            ...
                            Row(
                              children: [
                                Text(
                                  '${convertDateTimeToStringTime(controller.classroomInfos.value!.access[index].openTime)} - ',
                                  style: textTheme.bodyMedium!.copyWith(
                                      fontSize: 14,
                                      color: theme.primary.withOpacity(0.8),
                                      fontWeight: FontWeight.w500),
                                ),
                                if (controller.classroomInfos.value!.access[index].closeTime != null) ...[
                                  Text(
                                    convertDateTimeToStringTime(
                                        controller.classroomInfos.value!.access[index].closeTime!),
                                    style: textTheme.bodyMedium!.copyWith(
                                        fontSize: 14,
                                        color: theme.primary.withOpacity(0.8),
                                        fontWeight: FontWeight.w500),
